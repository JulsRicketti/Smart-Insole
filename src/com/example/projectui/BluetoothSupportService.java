 ...
 */
public class BluetoothSupportService {
    // Debugging
     ...
     */
    public BluetoothSupportService(Context context, Handler handler) {
  ...
  /*  public void write(byte[] out) {
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothActivity.TOAST, "Unable to connect device"+bundle);
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class AcceptThread extends Thread {
		...
		public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (BluetoothSupportService.this) {
                        switch (mState) {
                        case STATE_LISTEN:
    ...
    private class ConnectedThread extends Thread {
		...
		public void run() {
            ...
            if (mRestartServiceOnConnectionLost) {
                BluetoothSupportService.this.start();
            }
